...
describe("Authentication", () => {
    test('User is able to sign up only once', async () => {
        const username = "Jatin" + Math.random(); // Jatin0.12331313
        const password = "123456434";
    ...
    test('Signup request fails if the username is empty', async () => {
        const username = `Jatin-${Math.random()}` // Jatin-0.12312313
        const password = "1234563463"
...
//                 resolve(messageArray.shift())  // pop the first element of the array
//             } else {
//                 // here this interval stores the reference to the setInterval
//                 let interval = setInterval(() => { //setInterval repeats the fn until you clear interval
//                     if (messageArray.length > 0) {
...
//         ws1 = new WebSocket(WS_URL) // this is the websocket connection to my server
